...
import com.bitmavrick.screen.components.DurationPresetChips
    ...
    OutlinedCard(
        ...
        Column(
            ...
            Slider(
                ...
                valueRange = 1f..100f,
                onValueChangeFinished = { onEvent(ScreenFlashUiEvent.UpdateDuration(durationSliderPosition.toInt())) },
                track = {
